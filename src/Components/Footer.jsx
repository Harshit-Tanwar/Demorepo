...
function Footer() {
  return (
    <div className="w-full h-screen px-16 py-12 flex">
      <div className="w-1/2 h-full flex flex-col justify-between ">
        <div className="headings">
          <h1 className="text-[5vw] text-bold uppercase -mb-3 leading-none">
            Eye-
          </h1>
          <h1 className="text-[5vw] text-bold uppercase -mb-3 leading-none">
            Opening
      ...
      <div className="w-1/2 h-full flex flex-col justify-between">
        <h1 className="text-[5vw] text-bold uppercase -mb-5 leading-none">
          Presentations
        </h1>
        <div className="">
          <h5 className="pb-3">S:</h5>
          {["Facebook", "Instagram", "Twitter"].map((item, index) => (
            <a className="block text-l underline" href="#">
              {item}
            </a>
          ))}
        </div>
        <div className="flex justify-between">
          <div>
            <h5 className="pb-3">L:</h5>
            <div className="pb-4">
              <h5 className="block text-l underline">202-1965 W 4th Ave</h5>
              <h5 className="block text-l underline">Vancouver, Canada</h5>
            </div>
            <div>
              <h5 className="block text-l underline">30 Chukarina St</h5>
              <h5 className="block text-l underline">Lviv, Ukraine</h5>
            </div>
          </div>
          <div>
            <h5 className="pb-3">M:</h5>
            {[
              "Home",
              "Services",
              "Our Work",
        ...
        <div className="flex justify-between text-zinc-700">
          <h5>
            ...
            <span className="underline">Legal Terms</span>
          </h5>
          <h5 className="underline">Website by Obys</h5>
        </div>
      </div>
    </div>
  );
